...
public final class PseudoGameStateFactory implements ScotlandYard.Factory<Board.GameState> {
    ...
    public final class PseudoGameState implements Board.GameState {
        ...
        private PseudoGameState(GameSetup setup,
            ...
            for (Player p : detectives) {
                ...
                //if (tickets.get(ScotlandYard.Ticket.SECRET)!= null) { throw new IllegalArgumentException(); }
                //if (tickets.get(ScotlandYard.Ticket.DOUBLE)!= null ) { throw new IllegalArgumentException(); }
        ...
        private GameState mrXTurn(Move move) {
            ...
            return new PseudoGameState(setup, remainingPlayersInRound, log, mrX, detectives);
        }

        // Update detective position and return new game state
        private GameState detectiveTurn(Move move, Piece detective) {
            ...
            return new PseudoGameState(setup, remainingPlayersInRound, log, mrX, ImmutableList.copyOf(newDetectives));
        }
        ...
        public GameState advance(Move move) {
            ...
            GameState newState = move.accept(new Move.Visitor<GameState>(){
                @Override
    ...
    // Initialises first game state where no moves have taken place yet.
