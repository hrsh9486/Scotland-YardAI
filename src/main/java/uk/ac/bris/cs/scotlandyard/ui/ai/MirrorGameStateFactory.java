...
// */
////public final class MirrorGameStateFactory{
...
//                if (tickets.get(ScotlandYard.Ticket.SECRET)!= 0) { throw new IllegalArgumentException(); }
//                if (tickets.get(ScotlandYard.Ticket.DOUBLE)!=0 ) { throw new IllegalArgumentException(); }
//
//            }
//
...
//   // @Nonnull public MirrorGameState build(
//    //        GameSetup setup,
//    //        Player mrX,
//    //        ImmutableList<Player> detectives) {
//    //    return new MirrorGameState(setup, ImmutableSet.of(Piece.MrX.MRX), ImmutableList.of(), mrX, detectives);
//    //}
////}